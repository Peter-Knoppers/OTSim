...
/**
 * StatusBar.
 * <BR>A status bar is made of multiple zones. A zone can be any JComponent.
 * <br />
 * Copied/adapted from <a href="http://www.java2s.com/Code/Java/Swing-Components/Astatusbarismadeofmultiplezones.htm">A
 * status bar is made of multiple zones : Status Bar &lt;&lt; Swing Components
 * &lt;&lt; Java</a>.
 * <br >
 * <br />
...
public class StatusBar extends JComponent {
	...
	/**
	 * The key used to identify the default zone
	 */
	...
	/**
	 * Set a new border for this StatusBar.
	 * @param border Border; new border for this StatusBar
	 */
	...
	/**
	 * Add a new zone in the StatusBar
	 * @param id Name of the new zone
	 * @param zone Component that will occupy the zone
	 ...
	 * @param id String; ID of the component to retrieve
	 * @return Component; component that corresponds with the id, or null if
	 * there is no zone with the given ID
	 */
	 ...
	 */
	public void updateConstraint(String id, String newConstraint) {
		((PercentLayout) getLayout()).setConstraint(getZone(id), newConstraint); 
	}
	...
	public void setGap(int newGap) {
		((PercentLayout) getLayout()).setGap(newGap);		
	}
 ...
 * split using percentages. The following are allowed when adding components
 * to container:
 * <ul>
...
class PercentLayout implements LayoutManager2 {
	 ...
	 */
	/**
	 * Retrieve the gap of this PercentLayout.
	 * @return Integer; the gap of this PercentLayout
	 */
	public int getGap() {
		return gap;
	}
	 ...
	 */
	/**
	 * Retrieve the orientation of this PercentLayout.
	 * @return Integer; the orientaiton of this PercentLayout
	 */
	...
	public void setConstraint(Component component, Object constraints) {
		...
		} else if (constraints == null)	// null constraint means preferred size
			setConstraint(component, PREFERRED_SIZE);
		else
