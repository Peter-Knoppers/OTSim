...
public class Lane extends CrossSectionObject {
     ...
     * @param lateralPosition lateralStart Double; lateral position of left edge of this Lane
    ...
    public Lane(Lane lane) {
    	...
    	this.stopLineLane = lane.getStopLine();
   ...
   public void setLateralStart(double lateralPosition) {
		this.lateralPosition = lateralPosition;
	}
	...
	public void paint(GraphicsPanel graphicsPanel) {
    	Boolean autoGenerated = crossSectionElement.getCrossSection().getLink().isAutoGenerated();
    	...
    	if (stopLineLane != null)  {
    		...
    		Color oldColor = stopLineLane.getColor();
    		Color color = new Color(1f, 1f, 1f, 1f);
    		stopLineLane.setColor(color);
    		stopLineLane.setOpaque(true);
    		stopLineLane.paint(graphicsPanel);
    		stopLineLane.setColor(oldColor);
    		stopLineLane.setOpaque(oldOpaque);
    	}
    	if (turnArrow != null)
	...
	public String export() {
		...
		/* if ((getDestination() >= 0) && (crossSectionElement.getCrossSection().getLink().isAutoGenerated() 
				|| (crossSectionElement.getCrossSection().getLink().getToNode_r().isSink()) 
				|| (crossSectionElement.getCrossSection().getLink().getToNode_r().getNodeID()==6704)
				|| (crossSectionElement.getCrossSection().getLink().getToNode_r().getNodeID()==6596)
				|| (crossSectionElement.getCrossSection().getLink().getToNode_r().getNodeID()==6886)
				|| (crossSectionElement.getCrossSection().getLink().getToNode_r().getNodeID()==6607) ))
