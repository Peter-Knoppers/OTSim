...
public class Lane extends CrossSectionObject {
	...
	private CrossSectionElement cse;
...
/*	public ArrayList<Vertex> getLaneVerticesInner() {
		ArrayList<Vertex> result = GeoInfraCreation.GeometryTools.createParallelVertices(laneVerticesCenter, - getLateralWidth() / 2);
		return result;
	}*/
	public ArrayList<Vertex> getLaneVerticesInner() {
...
/*	public ArrayList<Vertex> getLaneVerticesOuter() {
		return GeoInfraCreation.GeometryTools.createParallelVertices(laneVerticesCenter, getLateralWidth() / 2);
	}*/
...
/*		if (GeometryTools.GeneralPathToString(polygon).startsWith("m 89.759,-100.562") || GeometryTools.GeneralPathToString(polygon).startsWith("m 88.440,-88.285")) {
	...
	public void paint(GraphicsPanel graphicsPanel) {
    	Boolean autoGenerated = cse.getCrossSection().getLink().isAutoGenerated();
...
//        		graphicsPanel.drawCircle(this.getCse().getCrossSection().getLink().network.selectedLaneControlPoint, Color.BLACK, 6);
